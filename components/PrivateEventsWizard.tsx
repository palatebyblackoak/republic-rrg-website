    ...
    return (
      <div className="border border-divider bg-surface p-10 md:p-14 text-center">
        ...
        <p className="mt-6 text-muted text-[15px] leading-[1.8] max-w-md mx-auto">
          Our events team will be in touch within one business day to plan your{" "}
          {form.occasion.toLowerCase()} for {form.guests} guests.
        </p>
      </div>
    );
  }
      ...
      {step === 0 && (
        <div>
          ...
          <p className="mt-3 text-muted text-[14px]">
            Choose one — we'll tailor the recommendations.
          </p>
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-6">
            <label className="block">
              ...
              <input
                ...
                className="mt-2 w-full bg-bg border border-divider text-cream px-4 py-3 text-[15px] focus:outline-none focus:border-accent"
              />
            </label>
            <label className="block">
              <span className="text-[11px] uppercase tracking-widest-2 text-muted">
              ...
              <input
                ...
                placeholder="e.g. 25"
                className="mt-2 w-full bg-bg border border-divider text-cream px-4 py-3 text-[15px] focus:outline-none focus:border-accent placeholder:text-muted/60"
              />
            </label>
          </div>
        </div>
        ...
        <div>
          ...
          <label className="block mt-6">
            ...
            <textarea
              ...
              placeholder="Menu preferences, dietary needs, anything we should know."
              className="mt-2 w-full bg-bg border border-divider text-cream px-4 py-3 text-[15px] focus:outline-none focus:border-accent placeholder:text-muted/60 resize-none"
            />
          </label>
        </div>
      )}
